...
import com.snowyfeng.spark_training.spark.session.CategorySortKey;
import com.snowyfeng.spark_training.spark.session.SessionAggrStatAccumulator;
import com.snowyfeng.spark_training.test.MockData;
import com.snowyfeng.spark_training.utils.*;
    ...
    private static void randomExtractSession(
                    ...
                    public Iterable<Tuple2<String, String>> call(
                        ...
                        while(iterator.hasNext()) {
                            ...
                            if(extractIndexList.contains(index)) {
                                ...
                                sessionRandomExtract.setSeachKeywords(StringUtils.getFieldFromConcatString(
                                        sessionAggrInfo, "\\|", Constants.FIELD_SEARCH_KEYWORDS));
                                sessionRandomExtract.setClickCategory(StringUtils.getFieldFromConcatString(
        ...
        extractSessionDetailRDD.foreach(new VoidFunction<Tuple2<String,Tuple2<String,Row>>>() {
            ...
            public void call(Tuple2<String, Tuple2<String, Row>> tuple) throws Exception {
                ...
                sessionDetail.setClickPrductId(row.isNullAt(7)?null:row.getLong(7));
